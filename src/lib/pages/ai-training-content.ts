...
<section id="sut">
  <div class="wrap">
    ...
    <h2 class="sec-h2 rv d1">Почему ChatGPT «в лоб»<br>не собирает твой продукт</h2>
...
<section id="program">
  <div class="wrap">
    ...
    <h2 class="sec-h2 rv d1">Твой месяц: 2 сессии, распаковка, 111 промптов —<br>на выходе работающий продукт</h2>
    ...
    <div class="tl">
      ...
      <div class="tl-item rv d2">
        ...
        <div class="tl-d">Тот же процесс, что и в «Распаковке» отдельным продуктом — бот разворачивает рабочую AI-команду в панели: агенты под твои задачи, доска задач, контроль расходов на AI. Входит в месяц, не доплачиваешь отдельно.</div>
      </div>
...
<section id="objections">
  <div class="wrap">
    ...
    <h2 class="sec-h2 rv d1">Знаю, о чём ты сейчас думаешь</h2>
    ...
    <div class="obj rv d2"><div class="obj-q">Нет времени</div><div class="obj-a">2 сессии + распаковка, график под тебя. Месяц — это 4 недели. Вопрос не во времени, а в приоритете: что важнее — смотреть или собрать.</div></div>
  </div>
</section>
