  ...
  <div class="w">
    <div class="wlay">
      <div>
        ...
        <h2 class="sh2 rv d1">От оплаты —<br>до работающего агентства</h2>
        <p class="sl rv d2" style="margin-bottom:0">Четыре шага. У каждого — понятный результат. Нажмите на шаг.</p>
  ...
  <div class="w">
    <div class="wlay">
      <div>
        ...
        <h2 class="sh2 rv d1">From payment —<br>to a working agency</h2>
        <p class="sl rv d2" style="margin-bottom:0">Four steps. Each one has a clear result. Click a step.</p>
        <div class="funnelw rv d3">
          <svg viewBox="0 0 280 270" width="100%" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <linearGradient id="fl1" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#FFD000" stop-opacity=".85"/><stop offset="100%" stop-color="#FFD000" stop-opacity=".3"/></linearGradient>
      ...
      <div class="wdiag rv d2">
        <div class="wi act" data-zone="1"><div class="wico">${icon("chat")}</div><span class="wchev">▾</span><div><div class="wtit">Step 1 · Unboxing in the bot</div><div class="wtx">Right after payment, the bot walks you through the methodology: what the business does, who's on the team, who the owner is versus who runs operations, and which tasks to hand off first. Not a box-ticking questionnaire — a real look at your situation.<div class="wres"><span class="ncl">Result</span><p>The system understands your business and knows what agency to build for it.</p></div></div></div></div>
        <div class="wi" data-zone="2"><div class="wico">${icon("box")}</div><span class="wchev">▾</span><div><div class="wtit">Step 2 · The workspace deploys (automatically)</div><div class="wtx">Right after unboxing, the system builds your personal workspace on its own — a Telegram Mini App named after your business: an AI director, agents, roles and starter tasks from your niche's template. No manual setup, no waiting.<div class="wres"><span class="ncl">Result</span><p>A working agency already exists and is waiting for you in Telegram.</p></div></div></div></div>
        <div class="wi" data-zone="3"><div class="wico">${icon("book")}</div><span class="wchev">▾</span><div><div class="wtit">Step 3 · Walkthrough</div><div class="wtx">A step-by-step guide: how to top up the AI budget, where to go, how to give the director tasks and read reports. Go at your own pace — no calls, no scrambling to keep up.<div class="wres"><span class="ncl">Result</span><p>You confidently use the panel yourself.</p></div></div></div></div>
        <div class="wi" data-zone="4"><div class="wico">✅</div><span class="wchev">▾</span><div><div class="wtit">Step 4 · First tasks — real work</div><div class="wtx">You give the director your first real task. It splits the work across the agents, checks the result before closing it, and sends you a report every evening at 6pm.<div class="wres"><span class="ncl">Result</span><p>The agency works for you — not the other way around.</p></div></div></div></div>
