...
<section id="gets" class="sec-light">
  <div class="w">
    ...
    <div class="ngrid">
      ...
      <div class="ncard rv"><div class="nbadge">04</div><div class="ntit">Работа стартует с первого входа</div><p class="ntx"><b>Не «начнём на следующей неделе».</b> Стартовые задачи из вашей анкеты уже стоят на доске, и одну вы ставите сами.</p></div>
...
<section id="objections" class="sec-light">
  <div class="w">
    ...
    <div class="obj rv d2"><div class="obj-q">Есть же Codex, Клод, ChatGPT — зачем мне ещё что-то?</div><div class="obj-a">Это инструменты, а не команда. Codex и Клод отвечают на конкретный запрос здесь и сейчас — но не держат в голове вашу нишу, не помнят вчерашние задачи, не проверяют свою же работу и не работают, пока вы не открыли чат. Распаковка — это готовая команда ролей с памятью о вашем бизнесе, директором, который проверяет результат, и досками задач, а не окно диалога, которое нужно каждый раз собирать заново.</div></div>
