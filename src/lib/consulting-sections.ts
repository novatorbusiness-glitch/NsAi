  ...
  <div class="w">
    <div class="wlay">
      <div>
        ...
        <p class="sl rv d2" style="margin-bottom:.75rem">За 2–3 дня до сессии вы заполняете короткую анкету: чем занимается бизнес, кто в команде, кто владелец, а кто ведёт операционку, какие задачи отдать в первую очередь. По нише и анкете система автоматически разворачивает агентство по готовому шаблону (см. примеры выше) — агенты, роли и стартовые задачи собираются не вручную, а кодом за секунды.</p>
        <p class="sl rv d2" style="margin-bottom:0">Сессия 90 минут — не сборка с нуля, а калибровка уже развёрнутого агентства под ваш бизнес и обучение работе с панелью. Шесть шагов, нажмите на любой.</p>
      ...
      <div class="wdiag rv d2">
        <div class="wi act" data-zone="1"><div class="wico">📦</div><span class="wchev">▾</span><div><div class="wtit">Шаг 1 · Workspace (10 мин)</div><div class="wtx">Ваш личный кабинет — Telegram Mini App с названием вашего бизнеса, а не «Мой проект» — уже развёрнут системой по шаблону. Смотрим вместе, что получилось. Открывается из того же Telegram-бота, который потом принимает от вас задачи и текстом, без захода в панель.</div></div></div>
        <div class="wi" data-zone="1"><div class="wico">🧑‍💼</div><span class="wchev">▾</span><div><div class="wtit">Шаг 2 · Директор и агенты (15 мин)</div><div class="wtx">AI-директор и от одного до пяти агентов уже настроены по шаблону — калибруем имена, роли и базы знаний под ваш реальный бизнес. Директору можно написать одну задачу — дальше он сам решает, кому её передать.</div></div></div>
        <div class="wi" data-zone="2"><div class="wico">🏛️</div><span class="wchev">▾</span><div><div class="wtit">Шаг 3 · Роли (10 мин)</div><div class="wtx">Роли агентов — из готового шаблона под вашу нишу (см. примеры выше), донастраиваем зоны ответственности под ваши реальные процессы. У каждого — понятная зона, не безликий помощник.</div></div></div>
