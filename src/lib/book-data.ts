...
export const BOOK_SUBCHAPTER_TITLES: Record<string, string> = {
	...
	"1-1-kognitivnye-lovushki": "Пять когнитивных ловушек, из-за которых ломаются даже дорогие запуски",
	"1-2-nejrokopiraiting": "Нейрокопирайтинг: как текст запускает предсказуемые реакции в голове читателя",
	"1-3-lid-magnit": "Лид-магнит: как создать бесплатный продукт, который клиент забирает сам",
	"1-4-vizualnye-stimuly": "Визуальные стимулы: как один образ останавливает автоматический скроллинг",
...
export const BOOK_CHAPTER_SUBS: BookChapterSub[] = [
	{
		...
		subs: [
			{ slug: "1-1-kognitivnye-lovushki", title: "Пять когнитивных ловушек, из-за которых ломаются даже дорогие запуски" },
			{ slug: "1-2-nejrokopiraiting", title: "Нейрокопирайтинг: как текст запускает предсказуемые реакции в голове читателя" },
			{ slug: "1-3-lid-magnit", title: "Лид-магнит: как создать бесплатный продукт, который клиент забирает сам" },
			{ slug: "1-4-vizualnye-stimuly", title: "Визуальные стимулы: как один образ останавливает автоматический скроллинг" },
		],
	},
	{
		id: 2,
