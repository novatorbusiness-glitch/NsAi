...
const TITLE = "Вход в бизнес на месяц — работа со мной";
const DESCRIPTION =
	"Сначала бесплатно показываю результат на вашей задаче: исследование и готовые артефакты. Зашло — захожу в проект на месяц. От 200 000 ₽.";
