...
const TITLE = "Показываю результат до того, как вы заплатили";
const DESCRIPTION =
	"Беру вашу задачу и отдаю готовые артефакты бесплатно — разбор, исследование, воронку. Зашло — захожу в проект на месяц и оставляю человека у руля. От 200 000 ₽.";
