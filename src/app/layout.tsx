...
export const metadata: Metadata = {
	...
	description:
		"Илья Новицкий (NCAi) — архитектор систем. Распаковка AI-агентства («агентство в коробке») для бизнеса и специалистов, обучение AI 1 на 1, бесплатная книга «Нейро-Воронка». Нейромаркетинг, поведенческая психология, AI-автоматизация.",
	keywords: [
		"Илья Новицкий",
		"NCAi",
		"нейромаркетинг",
