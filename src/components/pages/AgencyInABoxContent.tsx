...
import { AGENCY_MD } from "@/lib/agency-content";

/**
 * AgencyInABoxContent — контент защищённой страницы /agency-in-a-box.
 * Клиентский компонент: подключается только после ввода пароля (dynamic ssr:false),
 * поэтому текст глав НЕ попадает в статический HTML страницы.
 * Парсер markdown → React перенесён сюда из прежнего серверного page.tsx.
 */
...
export default function AgencyInABoxContent() {
	let src = AGENCY_MD || "# АГЕНТСТВО В КОРОБКЕ\n\nФайл не найден.";
